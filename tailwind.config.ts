    ...
    extend: {
      ...
      keyframes: {
        ...
        "border-glow": {
          ...
          "50%": { borderColor: "hsl(187 100% 50% / 0.8)" },
        },
        "float": {
      ...
      backgroundImage: {
        "cyber-grid": "linear-gradient(hsl(187 100% 50% / 0.03) 1px, transparent 1px), linear-gradient(90deg, hsl(187 100% 50% / 0.03) 1px, transparent 1px)",
